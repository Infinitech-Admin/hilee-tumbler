  ...
  return (
    <div className="fixed right-4 bottom-24 md:top-1/2 md:bottom-auto md:-translate-y-1/2 z-30 flex flex-col gap-4">
      ...
      >
        {socialLinks.map((social, index) => (
          ...
          >
            <Button
              size="icon"
              className={`h-12 w-12 rounded-full text-white shadow-lg transition-all duration-300 ${social.bg} ${social.hover} hover:scale-110 hover:shadow-xl`}
            >
      ...
      <Button
        ...
        className="h-14 w-14 rounded-full bg-gray-800 text-white shadow-lg transition-all duration-300 hover:bg-gray-700 hover:scale-110 hover:shadow-xl md:hidden"
