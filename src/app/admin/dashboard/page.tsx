            ...
            <div className="flex items-center justify-center min-h-screen w-full">
              <div className="text-center bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg max-w-md">
                ...
                <p className="text-sm text-sky-500 mb-4">
                  Make sure NEXT_PUBLIC_API_URL is set and your Laravel API is
                  running
                </p>
                <button
        ...
        <div className={`flex-1 min-w-0 ${isMobile ? "ml-0" : "ml-72"}`}>
          {isMobile && (
            <div className="sticky top-0 z-50 flex h-12 items-center gap-2 border-b bg-white/90 backdrop-blur-sm px-4 md:hidden shadow-sm">
              ...
              <span className="text-sm font-semibold bg-gradient-to-r from-sky-600 to-cyan-600 bg-clip-text text-transparent">
                Dashboard
              </span>
            </div>
          )}
          <main className="flex-1 overflow-auto p-3 sm:p-4 md:p-6">
            <div className="max-w-7xl mx-auto space-y-8">
              <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-sky-100">
                <h1 className="text-2xl sm:text-4xl font-bold bg-gradient-to-r from-sky-600 to-cyan-600 bg-clip-text text-transparent mb-2">
                  Admin Dashboard
                </h1>
              ...
              analytics.keyMetrics.totalOrders === 0 ? (
                <div className="space-y-6">
                  <Card className="border-sky-200 bg-white/70 backdrop-blur-sm shadow-xl">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4">
                      <div className="bg-sky-50 border border-sky-200 rounded-lg p-4">
                        ...
                        <p className="text-sky-700 text-sm mb-3">
                          {apiError ||
                      ...
                      {analytics.productsCount > 0 && (
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                          ...
                          <p className="text-green-700 text-sm">
                            Found {analytics.productsCount} products in your
                            database. Products endpoint is working correctly.
                          </p>
                        </div>
                      )}
                    </CardContent>
...
LARAVEL_API_TOKEN=your-sanctum-token-here`}
                ...
                <>
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        <p
                          ...
                          style={{ color: "#e0f2fe" }}
                        >
                          +{analytics.keyMetrics?.growthRate || 0}% from last
                          month
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        >
                          ₱
                          {(
                            analytics.keyMetrics?.averageOrderValue || 0
                          ).toLocaleString()}
                        </div>
                        <p
                          className="text-xs mt-1"
                  ...
                  <Card className="border-cyan-200 bg-white/70 backdrop-blur-sm shadow-xl">
                    <CardHeader>
                      <CardTitle className="text-sky-800">
                        Revenue Trends
                      </CardTitle>
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                          <AreaChart data={analytics.revenueData}>
                            <CartesianGrid
                              ...
                              stroke="#bae6fd"
                            />
                            <XAxis dataKey="date" stroke="#0369a1" />
                            <YAxis stroke="#0369a1" />
                            <Tooltip
                              contentStyle={{
                          ...
                          <ResponsiveContainer width="100%" height={250}>
                            <BarChart data={analytics.paymentMethodData}>
                              <CartesianGrid
                                ...
                                stroke="#bae6fd"
                              />
                              <XAxis dataKey="method" stroke="#0369a1" />
                              <YAxis stroke="#0369a1" />
                              <Tooltip
                                contentStyle={{
                                  backgroundColor: "#f0f9ff",
                      ...
                      analytics.popularProducts.length > 0 ? (
                        <div className="space-y-4">
                          {analytics.popularProducts.map((product, index) => (
                            <div
                              key={product.name}
                              className="flex items-center justify-between p-4 bg-gradient-to-r from-sky-50 to-cyan-50 rounded-lg border border-sky-200"
                            >
                              <div className="flex items-center space-x-4">
                                <div className="w-8 h-8 bg-gradient-to-br from-sky-500 to-cyan-500 text-white rounded-full flex items-center justify-center font-bold">
                                  {index + 1}
                                </div>
                                <div>
