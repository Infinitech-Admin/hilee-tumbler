  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="absolute -top-6 -left-6 w-28 h-28 rounded-full opacity-10 pointer-events-none"
          style={{ background: "radial-gradient(circle, white, transparent)" }}
        />
        <div
          className="absolute bottom-8 right-16 w-16 h-16 rounded-full opacity-5 pointer-events-none"
          style={{ background: "radial-gradient(circle, white, transparent)" }}
        />
      ...
      <div className="pt-20 px-6 pb-8 space-y-5">
        ...
        {hasShopLinks && (
          ...
          >
            <p className="text-xs font-bold text-purple-500 uppercase tracking-widest mb-3 flex items-center gap-1.5">
...
export default function ProductsAdminPage() {
  ...
  const columns: ColumnDef<Product>[] = [
    ...
    },
    {
      accessorKey: "image",
      header: () => (
        <span className="text-xs font-semibold text-purple-800">Image</span>
      ),
      cell: ({ row }) => (
      ...
      cell: ({ row }) => (
        <div>
          ...
          <div className="flex items-center gap-1 mt-1">
            ...
            {row.original.shopee_url && (
              <span
                className="w-2 h-2 rounded-full bg-orange-500"
                title="Shopee"
              />
            )}
            {row.original.lazada_url && (
              <span
    ...
    },
    {
      ...
      header: ({ column }) => (
        <Button
          variant="ghost"
          onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
          className="p-0 h-auto font-semibold text-purple-900 hover:text-purple-700 hidden md:flex"
        >
    ...
    },
    {
      ...
      header: () => (
        <span className="text-xs font-semibold text-purple-800">Status</span>
      ),
      cell: ({ row }) =>
        ...
        return (
          <div className="flex items-center gap-1">
            ...
            <Sheet>
              <SheetTrigger asChild>
                ...
                >
                  ...
                  <span className="ml-1.5 sr-only sm:not-sr-only hidden sm:inline text-xs font-medium">
                    View
                  </span>
                </Button>
              </SheetTrigger>
              <ProductDetailSheet
                product={
                  selectedProduct?.id === product.id ? selectedProduct : null
                }
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-44 shadow-xl border-purple-100"
              >
                <DropdownMenuLabel className="text-purple-700 text-xs font-bold uppercase tracking-wide">
                  Actions
                </DropdownMenuLabel>
                        ...
                        <DialogContent className="sm:max-w-[540px] max-h-[90vh] overflow-y-auto border-purple-200">
                          <DialogHeader className="pb-5 border-b border-purple-100">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <DialogTitle className="text-purple-900 text-lg">
                                  Add New Product
                                </DialogTitle>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setItemsPerPage(v === "all" ? -1 : parseInt(v))
                      }
                    >
                        ...
                        paginatedRows.map((row, index) => (
                          ...
                          >
                            {row.getVisibleCells().map((cell) => (
                              <td
                                key={cell.id}
                                className="px-4 py-3 align-middle text-xs sm:text-sm"
                              >
