  ...
  if (loading) {
    return (
      <SidebarProvider defaultOpen={!isMobile}>
        <div className="flex min-h-screen w-full bg-gradient-to-br from-cyan-50 to-teal-50">
          <AppSidebar />
        ...
        <div className={`flex-1 min-w-0 ${isMobile ? "ml-0" : "ml-64"}`}>
          ...
          <main className="flex-1 overflow-auto p-3 sm:p-4 md:p-6">
            <div className="max-w-full space-y-4 sm:space-y-6">
              ...
              <Card className="gap-0 p-0 bg-white/70 backdrop-blur-sm shadow-xl border-cyan-100">
                {/* Card Header — cyan/teal gradient, search + Add button */}
                <CardHeader className="pb-3 bg-gradient-to-r from-cyan-500 to-teal-300 text-white rounded-t-lg">
                ...
                <CardContent className="bg-white p-0">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between px-5 py-4 border-b border-gray-100">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <SelectTrigger className="w-24 h-9 border-gray-200 focus:border-cyan-400 text-sm">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full min-w-[600px]">
                      <thead>
                        <tr className="bg-gradient-to-r from-cyan-100 to-teal-100 border-b border-cyan-200">
                      ...
                      <tbody>
                        {paginatedRows.length === 0 ? (
                          ...
                          paginatedRows.map((row, index) => (
                            <tr
                              key={row.id}
                              className={`border-b border-cyan-100 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-teal-50 transition-all duration-200 ${index % 2 === 0 ? "bg-white" : "bg-cyan-50/30"}`}
                            >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-5 py-4 border-t border-gray-100 bg-gray-50/50">
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 hover:bg-white hover:text-cyan-600 hover:border hover:border-cyan-200 disabled:opacity-30 disabled:cursor-not-allowed transition-all text-xs font-semibold"
                        >
                          «
                        </button>
                        <button
                          ...
                          disabled={currentPage === 1}
                          className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 hover:bg-white hover:text-cyan-600 hover:border hover:border-cyan-200 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                        >
                              ...
                              <button
                                ...
                                className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm font-semibold transition-all ${
                                  currentPage === page
                                    ...
                                    : "text-gray-600 hover:bg-white hover:text-cyan-600 hover:border hover:border-cyan-200"
                                }`}
                              >
                                {page}
                              </button>
        ...
        <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
          <DialogContent className="sm:max-w-md w-full bg-white dark:bg-gray-900 rounded-xl shadow-xl p-6 sm:p-8">
            <DialogHeader className="text-center sm:text-left">
              <DialogTitle className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-teal-600">
                Contact Details
              </DialogTitle>
              <DialogDescription className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Quick overview of the selected contact.
              </DialogDescription>
            </DialogHeader>
            ...
            {selectedContact && (
              <div className="mt-6 space-y-4 text-gray-700 dark:text-gray-300 text-sm sm:text-base">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1">
                  <span className="font-semibold text-cyan-600">Phone:</span>
                  <span>{selectedContact.phone || "-"}</span>
                </div>

                <div className="flex flex-col gap-1">
                  <span className="font-semibold text-cyan-600">Message:</span>
                  <p className="p-3 bg-cyan-50 dark:bg-cyan-900 rounded-lg text-gray-800 dark:text-gray-200 text-sm sm:text-base max-h-40 overflow-auto">
            ...
            <DialogFooter className="mt-6 flex justify-center sm:justify-end">
              <Button
                variant="outline"
                className="bg-white dark:bg-gray-800 border-cyan-400 text-cyan-600 hover:bg-cyan-50 hover:text-cyan-700 transition-all"
