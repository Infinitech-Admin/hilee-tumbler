...
export default function UsersAdminPage() {
  ...
  useEffect(() => {
    const id = setTimeout(() => {
      if (globalFilter !== undefined) fetchUsers();
    }, 500);
  ...
  const fetchUserOrders = async (userId: number) => {
    try {
      ...
      const response = await fetch(
        `/api/orders?user_id=${userId}&per_page=100`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const columns: ColumnDef<User>[] = [
    {
      ...
      cell: ({ row }) => (
        <span className="font-bold text-cyan-700 bg-cyan-100 px-2 py-0.5 rounded-full text-xs">
          #{row.original.id}
        </span>
      ),
    },
    ...
    {
      accessorKey: "phone",
      header: () => <span className="font-semibold text-cyan-900">Phone</span>,
      cell: ({ row }) => (
    ...
    {
      accessorKey: "city",
      header: () => <span className="font-semibold text-cyan-900">City</span>,
      cell: ({ row }) => (
        <div className="text-sm text-gray-600 hidden lg:block">
          {row.original.city || "—"}
        </div>
    ...
    {
      accessorKey: "role",
      header: () => <span className="font-semibold text-cyan-900">Role</span>,
      cell: () => (
        <Badge className="text-xs bg-cyan-100 text-cyan-700 border-cyan-300 hover:bg-cyan-200">
          User
        </Badge>
      ),
    },
            ...
            >
              <DialogTrigger asChild>
                <Button
                  ...
                  className="h-8 w-8 p-0 sm:h-auto sm:w-auto sm:px-3 rounded-lg text-cyan-600 hover:text-cyan-800 hover:bg-cyan-100 transition-all"
                >
                  <Eye className="h-4 w-4" />
                  <span className="ml-1 sr-only sm:not-sr-only hidden sm:inline text-xs font-medium">
                    View
                  </span>
                </Button>
              </DialogTrigger>
              ...
              {selectedUser?.id === user.id && (
                <DialogContent className="w-full sm:max-w-2xl overflow-y-auto border-cyan-200">
                  <DialogHeader>
                  ...
                  <div className="space-y-6">
                    <Card className="gap-0 p-0 border-cyan-200 shadow-lg">
                      <CardHeader
                      ...
                      <CardContent className="space-y-4 pt-4">
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Badge className="mt-1 bg-cyan-100 text-cyan-700 border-cyan-300">
                              {selectedUser.role}
                            </Badge>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 text-sm bg-cyan-50 p-3 rounded-lg">
                        ...
                        {selectedUser.address && (
                          <div className="flex items-start gap-2 text-sm bg-cyan-50 p-3 rounded-lg">
                        ...
                        <div className="flex items-center gap-2 text-sm pt-3 border-t border-cyan-100">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-8 w-8 p-0 rounded-lg text-cyan-500 hover:bg-cyan-100 hover:text-cyan-700"
                >
              ...
              <DropdownMenuContent
                align="end"
                className="border-cyan-200 shadow-xl"
              >
                <DropdownMenuLabel className="text-cyan-700">
                  User Actions
                </DropdownMenuLabel>
                <DropdownMenuSeparator className="bg-cyan-100" />
                <DropdownMenuItem
                  onClick={() => handleViewOrders(user)}
                  className="hover:bg-cyan-50 focus:bg-cyan-50 cursor-pointer"
                >
                  <ShoppingBag className="mr-2 h-4 w-4 text-cyan-500" /> View
                  Orders
                </DropdownMenuItem>
                <DropdownMenuItem
                  ...
                  className="hover:bg-cyan-50 focus:bg-cyan-50 cursor-pointer"
                >
                  <Send className="mr-2 h-4 w-4 text-cyan-500" /> Send Email
                </DropdownMenuItem>
                <DropdownMenuSeparator className="bg-cyan-100" />
                <DropdownMenuItem
  ...
  const purpleBg = {
    background:
      "linear-gradient(160deg, #072a3a 0%, #0e4a5c 40%, #072a3a 100%)",
  };
        ...
        >
          ...
          <div className={`flex-1 min-w-0 ${isMobile ? "ml-0" : "ml-72"}`}>
            <div className="flex items-center justify-center min-h-screen">
              <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm px-8 py-5 rounded-2xl shadow-2xl border border-cyan-100">
  ...
  return (
    <SidebarProvider defaultOpen={!isMobile}>
            ...
            <div className="max-w-full space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-stretch justify-between">
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-semibold text-cyan-500 uppercase tracking-widest">
                      Total Customers
                    </p>
                    <p className="text-3xl font-bold text-cyan-900 leading-tight">
                      {users.length}
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #0891b2 0%, #0e7490 50%, #0d9488 100%)",
                  }}
                >
                  <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
                    ...
                    <div className="relative max-w-xs w-full">
                      ...
                      <Input
                        ...
                        className="pl-9 pr-3 py-2 w-full text-white placeholder:text-cyan-300 border-0 rounded-xl focus-visible:ring-2 focus-visible:ring-white/40"
                  ...
                  <table className="w-full min-w-[800px]">
                    <thead>
                      <tr
                        style={{
                          background:
                            "linear-gradient(135deg, #ecfeff, #f0fdff)",
                        }}
                      >
      ...
      <Dialog open={showOrdersDialog} onOpenChange={setShowOrdersDialog}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto border-cyan-200">
          <DialogHeader>
            <DialogTitle className="text-cyan-900">
            ...
            {loadingOrders ? (
              ...
              <div className="space-y-4">
                {userOrders.map((order) => (
                  <Card
                    key={order.id}
                    className="border-cyan-200 shadow-md overflow-hidden"
                  >
                    <div
                      className="h-1"
                      style={{
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <Badge
                              className={`text-xs ${order.status === "delivered" ? "bg-green-100 text-green-700 border-green-300" : order.status === "cancelled" ? "bg-red-100 text-red-700 border-red-300" : "bg-cyan-100 text-cyan-700 border-cyan-300"}`}
                            >
                              {order.status}
                            </Badge>
                          </div>
                          <div className="space-y-2 text-sm text-gray-600">
                            ...
                            {order.delivery_city && (
                              <p className="ml-6 text-xs text-cyan-400">
                        ...
                        <div className="text-right ml-4">
                          ...
                          <Badge className="mt-2 text-xs bg-cyan-50 text-cyan-600 border-cyan-200">
                          ...
                          <div className="space-y-2">
                            {order.items.map((item, i) => (
                              <div
                                ...
                                style={{ background: "rgba(236,254,255,0.8)" }}
                              >
                                <div className="flex-1">
                                  ...
                                  <div className="flex gap-1 mt-1 flex-wrap">
                                    <Badge className="text-xs bg-cyan-100 text-cyan-600 border-cyan-200">
                                      {item.category}
                                    </Badge>
                                    {item.is_spicy && (
        ...
        <DialogContent className="border-cyan-200">
          <DialogHeader>
            ...
            <DialogDescription className="text-cyan-400">
              Compose and send an email to this customer
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 mt-2">
            <div>
              <Label
                htmlFor="email-to"
                className="text-cyan-700 font-semibold text-xs uppercase tracking-wide"
              >
                To
              </Label>
              <Input
                ...
                disabled
                className="mt-1 bg-cyan-50 border-cyan-200 text-cyan-700"
              />
            </div>
            <div>
              <Label
            ...
            <div>
              ...
              <Textarea
                ...
                className="mt-1 min-h-[140px] border-cyan-200 focus-visible:ring-cyan-400"
              />
            </div>
          </div>
        ...
        <AlertDialogContent className="border-red-200">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              . They will no longer be able to log in, but their data will be
              preserved.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
